            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="flex flex-col items-center gap-4 shrink-0">
                ...
                <div className="flex gap-3">
                  <div className="flex items-center gap-3 px-5 py-3 bg-white/25 border border-white/50 rounded-2xl backdrop-blur-sm">
                    <Shield className="size-5 text-[#f0c040] shrink-0" />
                    <div>
                      <p className="text-white font-bold text-sm leading-none">100% Seguro</p>
                      <p className="text-white/80 text-xs mt-0.5">Datos protegidos</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 px-5 py-3 bg-white/25 border border-white/50 rounded-2xl backdrop-blur-sm">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 text-xs mt-0.5">2 años de trayectoria</p>
                    </div>
                  </div>
                </div>
                {/* Botones CTA */}
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-2xl bg-white/25 hover:bg-white/35 border-2 border-white/70 text-white text-sm font-bold transition-all duration-200"
                >
