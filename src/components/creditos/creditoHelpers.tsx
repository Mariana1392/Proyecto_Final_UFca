...
/**
 * Calcula el monto final (capital + intereses) aplicando la fórmula de interés simple:
 * M = C * (1 + i * n)
 * Donde:
 ...
 * - n = Número de períodos (plazo)
 */
export const calcularMontoInteresSimple = (C: number, i: number, n: number): number => {
  if (!C) return 0;
  return C * (1 + i * n);
};
