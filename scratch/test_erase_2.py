...
# Let's erase the text "OBJETIVO GENERAL" by horizontal interpolation from y = 90 to 134.
for y in range(90, 135):
...
crop_left_erased.save("scratch/crop_left_erased_2.png")
print("Saved crop_left_erased_2.png")
